export default function ImprintAndDataProtection() {
    return (
        <div className="content">
            Angaben gem. § 5 TMG: Vorname, Name Adresse PLZ Kontaktaufnahme:
            Telefon: Fax: E-Mail: Umsatzsteuer-ID
            Umsatzsteuer-Identifikationsnummer gem. § 27 a Umsatzsteuergesetz:
            DE XXX XXX XXX Haftungsausschluss – Disclaimer: Haftung für Inhalte
            ...
            indirekt verlinkten Webseiten haben wir keinen Einfluss. Daher
